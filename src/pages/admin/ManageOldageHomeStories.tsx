...
const ManageOldageHomeStories = () => {
  const [stories, setStories] = useState<OldageHomeStory[]>([]);
  ...
  return (
    <div className="p-6">
      <h2 className="text-2xl font-bold mb-6">Manage Oldage Home Stories</h2>
...
export default ManageOldageHomeStories