    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative bg-gradient-to-r from-orange-600 via-red-600 to-blue-600 text-white py-24">
        ...
        <div className="relative container mx-auto px-4">
          ...
          <h1 className="text-5xl font-bold text-center mb-6">English Newsletter</h1>
          <p className="text-xl text-white/90 max-w-3xl mx-auto text-center">
            Stay updated with our latest news, events, and spiritual insights through our monthly English newsletter.
          </p>
        </div>
      </div>
