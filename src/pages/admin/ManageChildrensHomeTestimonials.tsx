...
const ManageChildrensHomeTestimonials = () => {
  ...
  return (
    <div className="p-6">
      <h2 className="text-2xl font-bold mb-6">Manage Children's Home Testimonials</h2>
...
export default ManageChildrensHomeTestimonials;