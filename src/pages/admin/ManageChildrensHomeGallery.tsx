...
const ManageChildrensHomeGallery = () => {
  ...
  return (
    <div className="p-6">
      <h2 className="text-2xl font-bold mb-6">Manage Children's Home Gallery</h2>
...
export default ManageChildrensHomeGallery;